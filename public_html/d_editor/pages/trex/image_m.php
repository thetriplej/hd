...
<head>
	...
	<title>이미지 첨부</title>
	<script src="../../js/popup.js?v=<?php echo date('Y-m-d');?>" type="text/javascript" charset="utf-8"></script>
	<link rel="stylesheet" href="../../css/popup_mobile.css?v=<?php echo date('Y-m-d');?>" type="text/css"  charset="utf-8"/>
