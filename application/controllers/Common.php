    ...
    public function page_log($lang_type,$agent_mode){
        ...
        if(empty($result)) {
            $uri_array = array(
                ...
                "/product/detail_view?code=prince" => "<font color='blue'>".$agent_name."제품소개</font> - Prince".$lang_name,
                "/product/detail_view?code=settle" => "<font color='blue'>".$agent_name."제품소개</font> - Settle".$lang_name,
