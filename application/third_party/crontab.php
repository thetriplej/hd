 ...
 *
 * Interface for CLI crontab.php. Differentiates between cronjobs managed
...
class Crontab_Manager {
    ...
    /**
     * Signature of loaded crontab.php
     * @var string
     */
...
if (strtolower(php_sapi_name()) == 'cli' and  ! defined('CRONTAB_AS_LIB') and ! defined('BASEPATH'))
{
    ...
    // If is once-job, remove from crontab.php
...
/** End of file crontab.php.php **/
/** Location: ./application/third_party/crontab.php.php **/